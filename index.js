...
if(highScore[0].score < score){
  console.log(`you scored higher than ${highScore[0].name}, send me the screenshot I will update it`);
}
else if(highScore[1].score < score){
  console.log(chalk.yellow.bold(`you scored higher than ${highScore[1].name}, send me the screenshot, I will update it`));
}
else if(highScore[1].score == score){
console.log(chalk.yellow.bold(`You scored same as ${highScore[1].name}, send me the screenshot I will add your name to scoreboard`));
}
else{
